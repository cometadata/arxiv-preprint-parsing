...
async def run_inference(
    ...
    cmd = [
        ...
        "--served-model-name", model_id, "--tensor-parallel-size", "1", "--max-model-len", "16384",
    ...
    image_base_dir = "/data/test_pdf_images"
...
def main(
    ...
    download: bool = False, clear: bool = False, clear_cache: bool = False, model_name: str = "reducto/RolmOCR",
    ...
    if upload:
        ...
        if content is None:
            print(summary)
            return
        output_file = f"rolmocr_predictions_{datetime.now():%Y%m%d_%H%M%S}.jsonl"
